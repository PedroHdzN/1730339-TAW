...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 mt-5 mt-md-5">
                <h2 class="text-center mb-3 text-primary">{{$perfil->usuario->name}}</h2>
                <a href="{{$perfil->usuario->url}}" target="__blank">Visitar Sitio Web</a>
                <div class="biografia">
                    {!! $perfil->biografia !!}
                </div>
            </div>
    ...
    <h2 class="text-center my-5">Recetas Creada por: {{$perfil->usuario->name}}</h2>
